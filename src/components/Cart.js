  ...
  return (
    <section className={classnames({ invisible: !showCart })}>
      ...
      <button
        ...
        className="fixed top-0 right-0 mr-4 mt-4 w-12 bg-blue-500 p-2  rounded-full text-white hover:bg-blue-700 z-50"
      >
        <svg
        ...
        <div className="bg-red-500 rounded-full text-xs absolute w-6 h-6 flex justify-center items-center right-0 bottom-0 transform translate-x-2 translate-y-2 z-50">
          {cart.length}
        </div>
      </button>
    </section>
